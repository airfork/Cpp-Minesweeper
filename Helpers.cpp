...
std::string Helpers::getStringFromUser(const std::string &prompt) {
    std::cout << prompt << ": ";
...
int Helpers::getIntegerFromUser(const std::string &prompt) {
...
int Helpers::parseInt(const std::string &str) {
    try {
        return std::stoi(str);
